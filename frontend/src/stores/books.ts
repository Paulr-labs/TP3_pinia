...
export const useBooksStore = defineStore('books', () => {
  ...
  return {
    // State
    books, currentBook, loading, error, searchQuery, selectedCategory,
    // Getters
    filteredBooks, categoryStats,
    // Actions
    fetchBooks, fetchBook, createBook, updateBook, deleteBook, setSearchQuery, setCategory
  }
})